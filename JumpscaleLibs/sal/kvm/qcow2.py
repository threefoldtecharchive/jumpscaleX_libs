...
class Qcow2(j.baseclasses.object):
    ...
    def __init__(self, filename):
        ...
        if (len(data) < qcow2header.size) or not data.startswith(b"QFI"):
            raise Exception("Invalid header this is not a correct qcow2 file.")
    ...
    def _read_data(self, filename, size, offset=0):
        ...
        try:
            ...
            f.close()
            raise j.exceptions.Input("A error occured during reading of the file")
