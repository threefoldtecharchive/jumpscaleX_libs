...
class VXlan(j.baseclasses.object):
...
class Bridge(j.baseclasses.object):
...
class BondBridge(j.baseclasses.object):
...
class NameSpace(j.baseclasses.object):
    def __init__(self, name):
        JSBASE.__init__(self)
        self.name = name
...
class NetID(j.baseclasses.object):
    def __init__(self, oid):
        JSBASE.__init__(self)
...
class VethPair(j.baseclasses.object):
    def __init__(self, oid):
        JSBASE.__init__(self)
