class FlistService:
    ...
    def flist_meflistlinklinkname_get(
        self, flist, linkname, headers=None, query_params=None, content_type="application/json"
    ):
        """
    ...
    def flist_meflistrenametarget_get(
        self, flist, target, headers=None, query_params=None, content_type="application/json"
    ):
        """
    ...
    def flist_meflistpromote_get(
        self, srepo, sfile, dfile, headers=None, query_params=None, content_type="application/json"
    ):
        """
    ...
    def flist_byUsernameflist_get(
        self, username, flist, headers=None, query_params=None, content_type="application/json"
    ):
        """
