...
class GoldChainTypesFactory(j.baseclasses.object):
    """
    GoldChain Types Factory class
    """
    ...
    def test(self):
        """
        kosmos 'j.clients.goldchain.types.test()'
        """
        ...
        # in the string versions you can also add the GFT currency notation,
        # or use decimal notation to express the currency in the GFT Currency Unit,
        # rather than the primitive unit
        assert str(self.currency_new(value="1 GFT")) == "1"
