...
class ErrorTypes:
    ...
    def ExplorerInvalidResponse(self):
        ...
        Please report an issue at https://github.com/nbh-digital/goldchain/issues
    ...
    def DoubleSignError(self):
        ...
        https://github.com/nbh-digital/goldchain/issues
        """
