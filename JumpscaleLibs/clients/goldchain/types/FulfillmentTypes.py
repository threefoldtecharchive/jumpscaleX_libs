...
class ED25519Signature(BinaryData):
    ...
    """
    ED25519 Signature, used in GoldChain.
    """
...
class SignatureRequest:
    ...
    def signature_fulfill(self, public_key, signature):
        ...
        if self.fulfilled:
            raise j.clients.goldchain.errors.DoubleSignError(
...
class FulfillmentFactory(j.baseclasses.object):
    """
    ...
    def test(self):
        """
        kosmos 'j.clients.goldchain.types.fulfillments.test()'
        """
...
# as these are not used on any active GoldChain network
