...
class GoldChainExplorerGetClientStub(j.baseclasses.object):
    ...
    def explorer_post(self, endpoint, data):
        ...
        if match:
            ...
            transaction = j.clients.goldchain.types.transactions.from_json(data)
    ...
    def mint_condition_get(self, height, endpoint):
        ...
        if len(self._mint_conditions) == 0:
            raise j.clients.goldchain.errors.ExplorerServerError("no mint conditions defined", endpoint=endpoint)
