...
from JumpscaleLibs.clients.blockchain.goldchain.types.AtomicSwap import AtomicSwapContract
...
def main(self):
    ...
    # while goldchain does allow it, this client will raise an exception when you
    ...
    with pytest.raises(j.clients.goldchain.errors.AtomicSwapInsufficientAmountError):
