...
def main(self):
    ...
    # an example that shows how one can write logic around the GoldChain client,
    ...
    expected_text = """unconfirmed  Tx: 573290763024ae0a5e981412598a3d41bc02f8da628fa1e1adfe07d98818c689 |                          |         + 10 GFT         |
