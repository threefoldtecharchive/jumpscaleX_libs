...
def main(self):
    ...
    kosmos 'j.clients.goldchain.test(name="atomicswap_verify_sender")'
    """
    ...
    with pytest.raises(j.clients.goldchain.errors.AtomicSwapContractNotFound):
    ...
    with pytest.raises(j.clients.goldchain.errors.AtomicSwapContractInvalid):
