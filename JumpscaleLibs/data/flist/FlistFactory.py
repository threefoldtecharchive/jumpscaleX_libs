...
class FlistFactory(j.baseclasses.object):
    """
    this flist manipulation using zflist bin should install using `j.builders.storage.zflist.install(reset=True)`
    """

    _properties_ = None
    __jslocation__ = "j.data.flist"
